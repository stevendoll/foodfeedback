...
feature 'Practitioner Sign Up', :devise do
  ...
  scenario 'practitioner can sign up with valid email address and password' do
    practitioner_sign_up_with('test@example.com', 'please123', 'please123')
  ...
  scenario 'practitioner cannot sign up with invalid email address' do
    practitioner_sign_up_with('bogus', 'please123', 'please123')
  ...
  scenario 'practitioner cannot sign up without password' do
    practitioner_sign_up_with('test@example.com', '', '')
  ...
  scenario 'practitioner cannot sign up with a short password' do
    practitioner_sign_up_with('test@example.com', 'please', 'please')
  ...
  scenario 'practitioner cannot sign up without password confirmation' do
    practitioner_sign_up_with('test@example.com', 'please123', '')
  ...
  scenario 'practitioner cannot sign up with mismatched password and confirmation' do
    practitioner_sign_up_with('test@example.com', 'please123', 'mismatch')
    expect(page).to have_content "Password confirmation doesn't match"
  end
