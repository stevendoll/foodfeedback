...
RSpec.describe Practice::ClientsController, :type => :controller do
  ...
  describe "GET index" do
    ...
    context "clients" do
      ...
      it "cannot access practitioner client list" do
        get :index 
    ...
    context "practitioners" do
      ...
      it "can access practitioner client list" do
        get :index 
        expect(response.body).to have_content 'Clients'
      end
