...
# invitations - can invite other peers, nutritionists who work on your account, and patients

rails generate scaffold Comment creator_id:uuid user_id:uuid name:string description:text read:boolean deleted:boolean
rails generate scaffold CommentType name:string description:text display_order:float account_id:uuid
